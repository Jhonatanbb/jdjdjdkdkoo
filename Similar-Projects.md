Sherlock is not the first tools used to scan for available usernames...and it will not be the last.  Here are some links to other tools that we are aware of.
